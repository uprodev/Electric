...
<h1 class="document-type-label">
	<?php if ( $this->has_header_logo() ) $this->title(); ?> № <?php $this->invoice_number(); ?> от <?php $this->invoice_date(); ?>
</h1>
	...
	<tr>
		<td class="address billing-address">
            ...
            foreach ($bacs_meta as $key=>$item) {
                echo '<br><span><strong>' . $item . ':</strong> ' . get_post_meta($this->order->id, $key, true) . '</span>';
            }
            ?>
...
<table class="order-details">
	<thead>
		<tr>
            ...
            <th class="quantity"><?php _e( 'Ед. изм', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
            <th class="price"><?php _e( 'Цена без НДС', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
            <th class="price"><?php _e( 'Цена с НДС', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php foreach ( $this->get_order_items() as $item_id => $item ) :
            ...
            $unit = get_field('_woo_uom_input', $item['product_id'] );
			...
			<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', 'item-'.$item_id, esc_attr( $this->get_type() ), $this->order, $item_id ); ?>">
                ...
                <td class="quantity"><?php echo $unit; ?></td>


                <td class="price"><?php echo round($product->get_price()/6*5, 1) ?> р.</td>
	...
	<div id="footer">
        ...
        <table class="order-data-addresses">
            <tr>
                ...
                <td class="address billing-address">
                    <img style="margin-top: -60px; width:150px" src="<?= get_template_directory_uri() ?>/img/sign.png">
                </td>
                <td class="address billing-address">
                    <p><strong>Котович Д.С.</strong></p>
                </td>
            </tr>
