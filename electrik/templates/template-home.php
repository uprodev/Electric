...
?>
                    ...
                    <div class="content">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="bg">
                                            ...
                                            <img src="img/bg-2-1.jpg" alt="" class="mob">
                                        </div>
                        ...
                        <div class="item-wrap">
                            <div class="item item-white">
                                <div class="bg">
                                    <img src="img/bg-3-1.jpg" alt="">
                                    <img src="img/bg-3-1-1.jpg" alt="" class="mob">
                                </div>
                            ...
                            <div class="item">
                                <div class="bg">
                                    <img src="img/bg-3-2.jpg" alt="">
                                    <img src="img/bg-3-2-1.jpg" alt="" class="mob">
                                </div>
                                <h6>Товар дня</h6>
                        ...
                        <div class="info-wrap">
                            <ul>
                                <li>
                                    <div class="img-wrap">
                                        <img src="img/icon-8-1.svg" alt="">
                                    </div>
                                    <span>Быстрая доставка</span>
                                </li>
                                <li>
                                    <div class="img-wrap">
                                        <img src="img/icon-8-2.svg" alt="">
                                    </div>
                                    <span>Гарантия качества</span>
                                </li>
                                <li>
                                    <div class="img-wrap">
                                        <img src="img/icon-8-3.svg" alt="">
                                    </div>
                                    <span>Лучшие цены</span>
                                </li>
                                <li>
                                    <div class="img-wrap">
                                        <img src="img/icon-8-4.svg" alt="">
                                    </div>
        ...
        <section class="hot-product product">
            <div class="content-width">
                <h2>Популярные товары <img src="img/icon-9.svg" alt=""></h2>
                <div class="slider-wrap">
                    <div class="nav-wrap">
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="text-wrap">
                                        ...
                                        <div class="info-product">
                                            <p><img src="img/icon-12.svg" alt=""><i>В наличии ></i> 100 шт.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="product-item">
                                    ...
                                    <div class="text-wrap">
                                        ...
                                        <div class="info-product">
                                            <p><img src="img/icon-12.svg" alt=""><i>В наличии ></i> 10 шт.</p>
        ...
        <section class="popular">
            <div class="content-width">
                <div class="top">
                    <h2>Популярные разделы <img src="img/icon-15.svg" alt=""></h2>
                    <div class="btn-wrap">
        ...
        <section class="hot-product product">
            <div class="content-width">
                <h2>Акционные товары <img src="img/icon-17.svg" alt=""></h2>
                <div class="slider-wrap">
                    <div class="nav-wrap">
        ...
        <section class="brands">
            <div class="content-width">
                <div class="top">
                    <h2>Бренды <img src="img/icon-18.svg" alt=""></h2>
                    <div class="btn-wrap">
                ...
                <div class="content">
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-1.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-2.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-3.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-4.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-5.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-6.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-7.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-8.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-9.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-10.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-11.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-12.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-13.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-14.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-15.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
                            <img src="img/img-5-16.svg" alt="">
                        </a>
                    </div>
                    <div class="item">
                        <a href="#">
